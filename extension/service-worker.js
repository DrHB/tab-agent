...
function updateBadge(tabId) {
  ...
  chrome.action.setTitle({
    tabId,
    title: isActive ? 'BrowserAgent - Active (click to deactivate)' : 'BrowserAgent - Click to activate'
  });
}
...
function connectNativeHost() {
  ...
  try {
    nativePort = chrome.runtime.connectNative('com.browseragent.relay');
