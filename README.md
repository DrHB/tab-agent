...
|---|---|---|
| **Your logins** | [x] Uses existing sessions | [ ] Must re-authenticate |
| **Security** | [x] Click to activate specific tabs | [ ] Full browser access |
| **Privacy** | [x] Credentials never leave your browser | [ ] Agent sees everything |
| **Setup** | [x] Uses your Chrome | [ ] Downloads separate browser |
| **Visibility** | [x] Watch in real browser | [ ] Runs hidden/headless |
